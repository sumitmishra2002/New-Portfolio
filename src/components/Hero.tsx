        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <h2 className="text-gray-700">Data Analyst & Finance Professional</h2>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="border-2 border-gray-900 text-gray-900 px-6 py-3 rounded-lg hover:bg-gray-900 hover:text-white transition-colors flex items-center gap-2">
                <Download size={20} />
                Download Resume
              </button>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
              <p className="text-blue-600">MBA in Finance</p>
